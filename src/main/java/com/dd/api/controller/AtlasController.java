...
import com.dd.api.model.RequestParam;
...
public class AtlasController {
    ...
    public ResponseEntity<DefaultResponse> getClassificationGuid(@RequestBody @Valid RequestParam param, HttpServletRequest request)
        ...
        return ResponseUtils.getResponse(StatusEnum.SUCCESS,
                "classifications guid search success!!",guid);
    }

    @ApiOperation("Get hive table guid")
    @GetMapping("/hive_table/guid")
    public ResponseEntity<DefaultResponse> getHiveTableGuid(@RequestBody @Valid RequestParam param, HttpServletRequest request)
            throws AtlasServiceException {
    ...
    public ResponseEntity<DefaultResponse> getlineage(@RequestBody @Valid RequestParam param, HttpServletRequest request)
            throws AtlasServiceException {
